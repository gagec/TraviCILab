...
namespace TravisCILab
{
    ...
    public class Math
    {
        ...
        [Test]
        public void Subtract_InvalidCrowell()
        {
        ...
        [Test]
        public void Subtract_NullCrowell()
        {
        ...
        [Test]
        public void Multiply_InvalidCrowell()
        {
        ...
        [Test]
        public void Multiply_NullCrowell()
        {
         ...
         public void Divide_ValidCrowell()
        {
            ...
            Assert.AreEqual(6, Program.Divide("66", "11"));
            Assert.AreEqual(2.5, Program.Divide("5", "2"));
        }

        [Test]
        public void Divide_InvalidCrowell()
        {
        ...
        [Test]
        public void Divide_NullCrowell()
        {
        ...
        [Test]
        public void Power_InvalidCrowell()
        {
